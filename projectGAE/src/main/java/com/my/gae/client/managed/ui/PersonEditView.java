...
public class PersonEditView extends PersonEditView_Roo_Gwt {

    private static final Binder BINDER = GWT.create(Binder.class);

    private static com.my.gae.client.managed.ui.PersonEditView instance;
    ...
    public static com.my.gae.client.managed.ui.PersonEditView instance() {
        if (instance == null) {
    ...
    @Override
    public RequestFactoryEditorDriver<com.my.gae.client.proxy.PersonProxy, com.my.gae.client.managed.ui.PersonEditView> createEditorDriver() {
    ...
    interface Driver extends RequestFactoryEditorDriver<PersonProxy, PersonEditView> {
    }
}
