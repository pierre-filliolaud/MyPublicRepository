...
import com.my.gae.client.scaffold.request.EventSourceRequestTransport;
...
public class ScaffoldModule extends AbstractGinModule {
	...
	static class RequestFactoryProvider implements Provider<ApplicationRequestFactory> {
		...
		public RequestFactoryProvider(EventBus eventBus) {
			...
			requestFactory.initialize(eventBus, new EventSourceRequestTransport(eventBus, new GaeAuthRequestTransport(eventBus)));
		}
