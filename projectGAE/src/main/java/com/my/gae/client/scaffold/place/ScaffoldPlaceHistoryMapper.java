package com.my.gae.client.scaffold.place;
 ...
 * {@link com.my.gae.client.scaffold.place.Place Place}s your app can navigate to. In
 ...
 * {@link com.my.gae.client.scaffold.place.ProxyListPlace ProxyListPlace}s (which show
 * all entities of a particular type) and
 * {@link com.my.gae.client.scaffold.place.ProxyPlace ProxyPlace}s (which give access to
